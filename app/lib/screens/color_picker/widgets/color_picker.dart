...
class _ColorPickerState extends State<ColorPicker> {
  ...
  var _selectedColorPickerType = _ColorPickerType.spectrumCircle;
      ...
      body: Column(
        children: [
          Expanded(
            child: Stack(
              children: [
                _buildSelectedPicker(),
                Positioned(
                  right: 0,
                  top: 0,
                  child: DropdownMenu<_ColorPickerType>(
                    width: 53,
                    ...
                    onSelected: (type) {
                      setState(() {
                        if (type != null) {
                          _selectedColorPickerType = type;
                        }
                      });
                    },
                    dropdownMenuEntries: _ColorPickerType.values.map((type) {
                      return DropdownMenuEntry<_ColorPickerType>(
